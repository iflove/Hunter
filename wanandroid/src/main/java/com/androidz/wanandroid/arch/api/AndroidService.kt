...
import com.androidz.wanandroid.arch.api.data.*
...
interface AndroidService {
    ...
    suspend fun getProjectTypeDetail(@Path("page") page: Int, @Query("cid") cid: Int
    ): WanResponse<ArticleList>
    ...
    suspend fun searchHot(@Path("page") page: Int, @Field("k") key: String
    ): WanResponse<ArticleList>
    ...
    suspend fun shareArticle(@Field("title") title: String, @Field("link") url: String
    ): WanResponse<String>
