.class public Landroid/phone/wallet/nebulauc/android_phone_wallet_nebulauc_FrameworkMetaInfo;
.super Lcom/alipay/mobile/framework/MetaInfoCfg;
.source "android_phone_wallet_nebulauc_FrameworkMetaInfo.java"
...
.method private insertDescription(Ljava/util/Map;Ljava/lang/String;Lcom/alipay/mobile/framework/MicroDescription;)V
    ...
    .line 25
    .local v0, "descriptionList":Ljava/util/List;
    if-nez v0, :cond_1
    ...
    .line 22
    .end local v0    # "descriptionList":Ljava/util/List;
    :cond_2
    :goto_0
    return-void
.end method
...
.method public initDescriptionsWithMap(Ljava/util/Map;)V
    ...
    .line 39
    const-string v5, "com.alipay.mobile.nebulauc.impl.UcServiceImpl"

    invoke-virtual {v1, v5}, Lcom/alipay/mobile/framework/service/ServiceDescription;->setClassName(Ljava/lang/String;)Lcom/alipay/mobile/framework/MicroDescription;

    .line 40
    const-string v5, "com.alipay.mobile.h5container.service.UcService"
    ...
    .line 42
    const-string v5, "android-phone-wallet-nebulauc"

    invoke-direct {p0, p1, v5, v1}, Landroid/phone/wallet/nebulauc/android_phone_wallet_nebulauc_FrameworkMetaInfo;->insertDescription(Ljava/util/Map;Ljava/lang/String;Lcom/alipay/mobile/framework/MicroDescription;)V
