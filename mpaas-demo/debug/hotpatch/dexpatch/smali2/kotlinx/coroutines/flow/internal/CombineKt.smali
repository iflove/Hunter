...
.method public static final synthetic access$asChannel(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/Flow;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 1
    .param p0, "$this$access_u24asChannel"    # Lkotlinx/coroutines/CoroutineScope;
...
.method public static final synthetic access$asFairChannel(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/Flow;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 1
    .param p0, "$this$access_u24asFairChannel"    # Lkotlinx/coroutines/CoroutineScope;
    .param p1, "flow"    # Lkotlinx/coroutines/flow/Flow;
...
.method public static final synthetic access$onReceive(Lkotlinx/coroutines/selects/SelectBuilder;ZLkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function2;)V
    .locals 0
    .param p0, "$this$access_u24onReceive"    # Lkotlinx/coroutines/selects/SelectBuilder;
    .param p1, "isClosed"    # Z
    .param p2, "channel"    # Lkotlinx/coroutines/channels/ReceiveChannel;
    .param p3, "onClosed"    # Lkotlin/jvm/functions/Function0;
    .param p4, "onReceive"    # Lkotlin/jvm/functions/Function2;
...
.method private static final asChannel(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/Flow;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 8
    .param p0, "$this$asChannel"    # Lkotlinx/coroutines/CoroutineScope;
    .param p1, "flow"    # Lkotlinx/coroutines/flow/Flow;
...
.method private static final asFairChannel(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/Flow;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 8
    .param p0, "$this$asFairChannel"    # Lkotlinx/coroutines/CoroutineScope;
    .param p1, "flow"    # Lkotlinx/coroutines/flow/Flow;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final combineTransformInternal(Lkotlinx/coroutines/flow/FlowCollector;Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function4;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 7
    .param p0, "$this$combineTransformInternal"    # Lkotlinx/coroutines/flow/FlowCollector;
    .param p1, "first"    # Lkotlinx/coroutines/flow/Flow;
    .param p2, "second"    # Lkotlinx/coroutines/flow/Flow;
...
.method private static final onReceive(Lkotlinx/coroutines/selects/SelectBuilder;ZLkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function2;)V
    .locals 4
    .param p0, "$this$onReceive"    # Lkotlinx/coroutines/selects/SelectBuilder;
    .param p1, "isClosed"    # Z
    .param p2, "channel"    # Lkotlinx/coroutines/channels/ReceiveChannel;
    .param p3, "onClosed"    # Lkotlin/jvm/functions/Function0;
    .param p4, "onReceive"    # Lkotlin/jvm/functions/Function2;
    ...
    new-instance v2, Lkotlinx/coroutines/flow/internal/CombineKt$onReceive$1;

    const/4 v3, 0x0

    invoke-direct {v2, p3, p4, v3}, Lkotlinx/coroutines/flow/internal/CombineKt$onReceive$1;-><init>(Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)V

    check-cast v2, Lkotlin/jvm/functions/Function2;

    invoke-interface {p0, v1, v2}, Lkotlinx/coroutines/selects/SelectBuilder;->invoke(Lkotlinx/coroutines/selects/SelectClause1;Lkotlin/jvm/functions/Function2;)V
...
.method public static final zipImpl(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function3;)Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v1, p0, p1, p2}, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function3;)V
