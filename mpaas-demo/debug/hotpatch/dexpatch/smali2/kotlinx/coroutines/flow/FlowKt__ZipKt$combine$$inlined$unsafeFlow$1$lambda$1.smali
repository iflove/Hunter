...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    move-object v2, v4
    ...
    iget-object v3, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local v3, "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    .local v4, "b":Ljava/lang/Object;
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->L$3:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->L$1:Ljava/lang/Object;

    iget-object v6, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->L$0:Ljava/lang/Object;
    ...
    .end local v3    # "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    .end local v4    # "b":Ljava/lang/Object;
    :cond_2
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->p$:Lkotlinx/coroutines/flow/FlowCollector;

    .local v5, "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->p$1:Ljava/lang/Object;

    .line 36
    .restart local v4    # "b":Ljava/lang/Object;
    iget-object v6, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->this$0:Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1;

    iget-object v6, v6, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1;->$transform$inlined:Lkotlin/jvm/functions/Function3;
    ...
    iput-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->L$3:Ljava/lang/Object;

    iput v3, p0, Lkotlinx/coroutines/flow/FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1;->label:I

    invoke-interface {v6, v1, v4, p0}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 35
    .end local v5    # "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    .restart local v3    # "$this$combineTransformInternal":Lkotlinx/coroutines/flow/FlowCollector;
    :goto_0
    ...
    invoke-interface {v6, v5, p0}, Lkotlinx/coroutines/flow/FlowCollector;->emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
