...
.method public final update(Lkotlin/coroutines/CoroutineContext;I)Lkotlinx/coroutines/flow/internal/ChannelFlow;
    ...
    .local v1, "$i$a$-assert-ChannelFlow$update$newCapacity$1":I
    ...
    .end local v1    # "$i$a$-assert-ChannelFlow$update$newCapacity$1":I
    :goto_1
    if-eqz v1, :cond_7
    ...
    .local v1, "$i$a$-assert-ChannelFlow$update$newCapacity$2":I
    if-ltz p2, :cond_9
    ...
    .end local v1    # "$i$a$-assert-ChannelFlow$update$newCapacity$2":I
    :goto_3
    if-eqz v2, :cond_a
    ...
    .line 53
    :cond_d
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/flow/internal/ChannelFlow;->create(Lkotlin/coroutines/CoroutineContext;I)Lkotlinx/coroutines/flow/internal/ChannelFlow;
