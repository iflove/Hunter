...
.method public emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->result:Ljava/lang/Object;
    ...
    .line 24
    iget v3, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->label:I
    ...
    .local v4, "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    iget-object v2, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->L$3:Ljava/lang/Object;

    iget-object v5, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->L$2:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->L$0:Ljava/lang/Object;

    check-cast v5, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;

    .end local p0    # "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    .local v5, "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    ...
    .end local v4    # "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    .end local v5    # "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    .restart local p0    # "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    :cond_1
    ...
    .line 136
    .local v6, "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    iget-object v7, p0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;->$skipped$inlined:Lkotlin/jvm/internal/Ref$IntRef;

    iget v7, v7, Lkotlin/jvm/internal/Ref$IntRef;->element:I

    iget-object v8, p0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;->this$0:Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1;

    iget v8, v8, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1;->$count$inlined:I

    if-lt v7, v8, :cond_4

    iget-object v7, p0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;->$this_unsafeFlow$inlined:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    iput-object v3, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->L$2:Ljava/lang/Object;

    iput-object v5, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1$1;->L$3:Ljava/lang/Object;
    ...
    .line 137
    .end local v6    # "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    .end local p0    # "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    .restart local v2    # "value":Ljava/lang/Object;
    .restart local v4    # "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    .local v5, "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    :goto_1
    move v6, v4
    ...
    .end local v4    # "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    .local v5, "value":Ljava/lang/Object;
    .restart local v6    # "$i$a$-collect-FlowKt__LimitKt$drop$2$1":I
    :cond_4
    ...
    .local v2, "this":Lkotlinx/coroutines/flow/FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1;
    :goto_2
