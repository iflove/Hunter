...
.method public static final distinctUntilChanged(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/flow/Flow;
    ...
    .local v0, "$this$distinctUntilChangedBy$iv":Lkotlinx/coroutines/flow/Flow;
    const/4 v1, 0x0

    .line 58
    .local v1, "$i$f$distinctUntilChangedBy$FlowKt__DistinctKt":I
    const/4 v2, 0x0

    .line 59
    .local v2, "$i$f$unsafeFlow":I
    new-instance v3, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChanged$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1;

    invoke-direct {v3, v0, p1}, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChanged$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 27
    .end local v0    # "$this$distinctUntilChangedBy$iv":Lkotlinx/coroutines/flow/Flow;
    .end local v1    # "$i$f$distinctUntilChangedBy$FlowKt__DistinctKt":I
    return-object v3
.end method
...
.method public static final distinctUntilChangedBy(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function1;)Lkotlinx/coroutines/flow/Flow;
    ...
    .line 62
    .local v2, "$i$f$unsafeFlow":I
    new-instance v3, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1;

    invoke-direct {v3, v0, p1}, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function1;)V
...
.method private static final distinctUntilChangedBy$FlowKt__DistinctKt(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/flow/Flow;
    ...
    .line 46
    .local v0, "$i$f$distinctUntilChangedBy$FlowKt__DistinctKt":I
    const/4 v1, 0x0

    .line 64
    .local v1, "$i$f$unsafeFlow":I
    new-instance v2, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$3;

    invoke-direct {v2, p0, p1, p2}, Lkotlinx/coroutines/flow/FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$3;-><init>(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;)V
