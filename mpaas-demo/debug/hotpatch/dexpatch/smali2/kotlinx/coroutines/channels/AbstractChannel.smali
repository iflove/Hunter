...
.method private final enqueueReceive(Lkotlinx/coroutines/channels/Receive;)Z
    ...
    .line 569
    .local v7, "$i$a$-addLastIfPrev-AbstractChannel$enqueueReceive$result$1":I
    instance-of v8, v6, Lkotlinx/coroutines/channels/Send;

    .end local v6    # "it":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .end local v7    # "$i$a$-addLastIfPrev-AbstractChannel$enqueueReceive$result$1":I
    ...
    invoke-virtual {v5, v6, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->addNext(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Z
    ...
    .end local v4    # "$i$f$addLastIfPrev":I
    :cond_3
    invoke-virtual {p0}, Lkotlinx/coroutines/channels/AbstractChannel;->getQueue()Lkotlinx/coroutines/internal/LockFreeLinkedListHead;
    ...
    .line 1082
    .local v4, "$i$f$addLastIfPrevAndIf":I
    move-object v5, v0

    .local v5, "this_$iv$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    const/4 v6, 0x0

    .line 1083
    .local v6, "$i$f$makeCondAddOp":I
    new-instance v7, Lkotlinx/coroutines/channels/AbstractChannel$enqueueReceive$$inlined$addLastIfPrevAndIf$1;
    ...
    invoke-direct {v7, v8, v9, p0}, Lkotlinx/coroutines/channels/AbstractChannel$enqueueReceive$$inlined$addLastIfPrevAndIf$1;-><init>(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/channels/AbstractChannel;)V
    ...
    .line 1082
    .end local v5    # "this_$iv$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .end local v6    # "$i$f$makeCondAddOp":I
    move-object v5, v7

    .line 1086
    .local v5, "condAdd$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;
    :goto_1
    nop
    ...
    .line 1088
    .local v6, "prev$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    move-object v7, v6
    ...
    .line 570
    .local v8, "$i$a$-addLastIfPrevAndIf-AbstractChannel$enqueueReceive$result$2":I
    instance-of v9, v7, Lkotlinx/coroutines/channels/Send;

    .end local v7    # "it":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .end local v8    # "$i$a$-addLastIfPrevAndIf-AbstractChannel$enqueueReceive$result$2":I
    ...
    invoke-virtual {v6, v7, v0, v5}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->tryCondAddNext(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;)I
    ...
    .line 1086
    .end local v6    # "prev$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    goto :goto_1

    .line 1091
    .restart local v6    # "prev$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    :cond_5
    goto :goto_2
    ...
    .line 568
    .end local v0    # "this_$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .end local v4    # "$i$f$addLastIfPrevAndIf":I
    .end local v5    # "condAdd$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;
    .end local v6    # "prev$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    :goto_2
    move v0, v2
    ...
    .line 1087
    .local v0, "this_$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .restart local v4    # "$i$f$addLastIfPrevAndIf":I
    .restart local v5    # "condAdd$iv":Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;
    :cond_8
    new-instance v2, Lkotlin/TypeCastException;
...
.method private final registerSelectReceiveOrClosed(Lkotlinx/coroutines/selects/SelectInstance;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 1095
    .local v3, "$i$f$closed$kotlinx_coroutines_core":I
    ...
    .end local v3    # "$i$f$closed$kotlinx_coroutines_core":I
    ...
    .line 1096
    .local v3, "$i$f$value$kotlinx_coroutines_core":I
    ...
    .end local v3    # "$i$f$value$kotlinx_coroutines_core":I
    invoke-static {v1}, Lkotlinx/coroutines/channels/ValueOrClosed;->box-impl(Ljava/lang/Object;)Lkotlinx/coroutines/channels/ValueOrClosed;
...
.method protected cleanupSendQueueOnCancel()V
    ...
    .local v1, "$i$a$-assert-AbstractChannel$cleanupSendQueueOnCancel$1":I
    if-ne v2, v0, :cond_0
    ...
    .end local v1    # "$i$a$-assert-AbstractChannel$cleanupSendQueueOnCancel$1":I
    :goto_1
    if-eqz v3, :cond_1
    ...
    .line 624
    .end local v2    # "send":Lkotlinx/coroutines/channels/Send;
    goto :goto_0
...
.method protected pollSelectInternal(Lkotlinx/coroutines/selects/SelectInstance;)Ljava/lang/Object;
    ...
    .line 516
    .local v2, "send":Lkotlinx/coroutines/channels/Send;
    iget-object v3, v0, Lkotlinx/coroutines/channels/AbstractChannel$TryPollDesc;->resumeToken:Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v2, v3}, Lkotlinx/coroutines/channels/Send;->completeResumeSend(Ljava/lang/Object;)V

    .line 517
    iget-object v3, v0, Lkotlinx/coroutines/channels/AbstractChannel$TryPollDesc;->pollResult:Ljava/lang/Object;
...
.method public final receiveOrClosed(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 1093
    .local v5, "$i$f$closed$kotlinx_coroutines_core":I
    ...
    .end local v5    # "$i$f$closed$kotlinx_coroutines_core":I
    goto :goto_0
    ...
    .restart local v3    # "this_$iv$iv":Lkotlinx/coroutines/channels/ValueOrClosed$Companion;
    move-object v4, v1
    ...
    .line 1094
    .local v5, "$i$f$value$kotlinx_coroutines_core":I
    invoke-static {v4}, Lkotlinx/coroutines/channels/ValueOrClosed;->constructor-impl(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v5    # "$i$f$value$kotlinx_coroutines_core":I
    :goto_0
    nop
...
.method final synthetic receiveSuspend(ILkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 548
    .local v5, "$i$a$-suspendAtomicCancellableCoroutine-AbstractChannel$receiveSuspend$2":I
    ...
    .end local v5    # "$i$a$-suspendAtomicCancellableCoroutine-AbstractChannel$receiveSuspend$2":I
    ...
    .restart local v5    # "$i$a$-suspendAtomicCancellableCoroutine-AbstractChannel$receiveSuspend$2":I
