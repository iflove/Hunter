...
.method public constructor <init>(JLkotlinx/coroutines/internal/Segment;)V
    ...
    iput-object v0, p0, Lkotlinx/coroutines/internal/Segment;->_next:Ljava/lang/Object;

    .line 122
    iput-object v0, p0, Lkotlinx/coroutines/internal/Segment;->prev:Ljava/lang/Object;
...
.method private final moveNextToRight(Lkotlinx/coroutines/internal/Segment;)V
    .locals 6
    .param p1, "next"    # Lkotlinx/coroutines/internal/Segment;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TS;)V"
        }
    ...
    .line 163
    .local v0, "curNext":Lkotlinx/coroutines/internal/Segment;
    ...
    .line 161
    .end local v0    # "curNext":Lkotlinx/coroutines/internal/Segment;
    :cond_1
    goto :goto_0
...
.method private final movePrevToLeft(Lkotlinx/coroutines/internal/Segment;)V
    .locals 6
    .param p1, "prev"    # Lkotlinx/coroutines/internal/Segment;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TS;)V"
        }
    ...
    .line 175
    .local v0, "curPrev":Lkotlinx/coroutines/internal/Segment;
    ...
    .line 173
    .end local v0    # "curPrev":Lkotlinx/coroutines/internal/Segment;
    :cond_1
    goto :goto_0
...
.method public final casNext(Lkotlinx/coroutines/internal/Segment;Lkotlinx/coroutines/internal/Segment;)Z
    .locals 1
    .param p1, "expected"    # Lkotlinx/coroutines/internal/Segment;
    .param p2, "value"    # Lkotlinx/coroutines/internal/Segment;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TS;TS;)Z"
        }
...
.method public final remove()V
    ...
    .local v0, "$i$a$-assert-Segment$remove$1":I
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/Segment;->getRemoved()Z

    move-result v0

    .end local v0    # "$i$a$-assert-Segment$remove$1":I
    if-eqz v0, :cond_0
    ...
    .line 142
    .local v0, "next":Lkotlinx/coroutines/internal/Segment;
    ...
    .line 144
    .local v1, "prev":Lkotlinx/coroutines/internal/Segment;
    ...
    .line 142
    .end local v1    # "prev":Lkotlinx/coroutines/internal/Segment;
    :cond_4
    return-void

    .line 141
    .end local v0    # "next":Lkotlinx/coroutines/internal/Segment;
    :cond_5
    return-void
.end method
