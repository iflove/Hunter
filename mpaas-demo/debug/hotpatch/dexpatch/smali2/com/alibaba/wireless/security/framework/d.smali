...
.method private a(Ljava/lang/String;Lcom/alibaba/wireless/security/framework/d$a;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    const-string/jumbo v5, "packageInfo == null"
...
.method private a(Ljava/lang/String;Lcom/alibaba/wireless/security/framework/d$a;Landroid/content/Context;Ljava/lang/String;)Lcom/alibaba/wireless/security/framework/c;
    ...
    :try_start_8
    invoke-direct {v9, v8, v10, v11}, Lcom/alibaba/wireless/security/framework/d;->a(Ljava/lang/String;Lcom/alibaba/wireless/security/framework/d$a;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {v13, v4, v7}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v14, v5, v8}, Lcom/alibaba/wireless/security/framework/a;->a(Landroid/content/pm/PackageInfo;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v12, v4, v2, v3}, Lcom/alibaba/wireless/security/framework/utils/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    :goto_8
    invoke-direct {v9, v7, v2, v3}, Lcom/alibaba/wireless/security/framework/d;->a(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :cond_5
    :try_start_b
    invoke-direct {v9, v8, v13}, Lcom/alibaba/wireless/security/framework/d;->b(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_b
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_b .. :try_end_b} :catch_16
    ...
    invoke-static {v8, v7, v1, v2, v3}, Lcom/alibaba/wireless/security/framework/utils/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V

    invoke-static {}, Lcom/alibaba/wireless/security/framework/utils/a;->b()J

    move-result-wide v1

    iget-boolean v3, v10, Lcom/alibaba/wireless/security/framework/d$a;->d:Z
    ...
    invoke-direct {v9, v5, v6, v3}, Lcom/alibaba/wireless/security/framework/d;->b(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/ClassLoader;
    ...
    invoke-static {v8, v7, v3, v1, v2}, Lcom/alibaba/wireless/security/framework/utils/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    iget-object v7, v10, Lcom/alibaba/wireless/security/framework/d$a;->c:Ljava/io/File;
    ...
    iget-object v7, v10, Lcom/alibaba/wireless/security/framework/d$a;->a:Ljava/io/File;
    ...
    move-result-object v1
    :try_end_e
    .catch Ljava/lang/InstantiationException; {:try_start_e .. :try_end_e} :catch_15
    .catch Ljava/lang/IllegalAccessException; {:try_start_e .. :try_end_e} :catch_14
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_e .. :try_end_e} :catch_13
    .catchall {:try_start_e .. :try_end_e} :catchall_2

    :try_start_f
    move-object/from16 v33, v1

    check-cast v33, Lcom/alibaba/wireless/security/open/initialize/ISecurityGuardPlugin;

    new-instance v22, Lcom/alibaba/wireless/security/framework/c;
    :try_end_f
    .catch Ljava/lang/InstantiationException; {:try_start_f .. :try_end_f} :catch_12
    .catch Ljava/lang/IllegalAccessException; {:try_start_f .. :try_end_f} :catch_14
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_f .. :try_end_f} :catch_13
    ...
    :try_end_10
    .catch Ljava/lang/InstantiationException; {:try_start_10 .. :try_end_10} :catch_11
    .catch Ljava/lang/IllegalAccessException; {:try_start_10 .. :try_end_10} :catch_10
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_10 .. :try_end_10} :catch_f
    ...
    move-result v4
    :try_end_11
    .catch Ljava/lang/InstantiationException; {:try_start_11 .. :try_end_11} :catch_e
    .catch Ljava/lang/IllegalAccessException; {:try_start_11 .. :try_end_11} :catch_d
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_11 .. :try_end_11} :catch_f
    ...
    .catch Ljava/lang/InstantiationException; {:try_start_12 .. :try_end_12} :catch_e
    .catch Ljava/lang/IllegalAccessException; {:try_start_12 .. :try_end_12} :catch_d
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_12 .. :try_end_12} :catch_f
    ...
    invoke-interface/range {v33 .. v38}, Lcom/alibaba/wireless/security/open/initialize/ISecurityGuardPlugin;->onPluginLoaded(Landroid/content/Context;Lcom/alibaba/wireless/security/framework/IRouterComponent;Lcom/alibaba/wireless/security/framework/ISGPluginInfo;Ljava/lang/String;[Ljava/lang/Object;)Lcom/alibaba/wireless/security/framework/IRouterComponent;
    ...
    invoke-static {v8, v13, v1, v14, v15}, Lcom/alibaba/wireless/security/framework/utils/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V

    invoke-static {}, Lcom/alibaba/wireless/security/framework/utils/a;->b()J

    move-result-wide v4
    :try_end_13
    .catch Ljava/lang/InstantiationException; {:try_start_13 .. :try_end_13} :catch_e
    .catch Ljava/lang/IllegalAccessException; {:try_start_13 .. :try_end_13} :catch_d
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_13 .. :try_end_13} :catch_f
    ...
    :try_end_14
    .catch Ljava/lang/InstantiationException; {:try_start_14 .. :try_end_14} :catch_e
    .catch Ljava/lang/IllegalAccessException; {:try_start_14 .. :try_end_14} :catch_d
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_14 .. :try_end_14} :catch_f
    ...
    invoke-static {v1, v4}, Lcom/alibaba/wireless/security/framework/utils/f;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v4, v9, Lcom/alibaba/wireless/security/framework/d;->e:Lcom/alibaba/wireless/security/framework/IRouterComponent;
    ...
    invoke-interface {v4, v5, v2}, Lcom/alibaba/wireless/security/framework/IRouterComponent;->doCommand(I[Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "10102"

    invoke-static {v8, v13, v1, v14, v15}, Lcom/alibaba/wireless/security/framework/utils/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_15
    .catch Ljava/lang/InstantiationException; {:try_start_15 .. :try_end_15} :catch_e
    .catch Ljava/lang/IllegalAccessException; {:try_start_15 .. :try_end_15} :catch_d
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_15 .. :try_end_15} :catch_f
    ...
    invoke-virtual {v13}, Lcom/alibaba/wireless/security/open/SecException;->getErrorCode()I
    ...
    invoke-virtual {v13}, Lcom/alibaba/wireless/security/open/SecException;->toString()Ljava/lang/String;
    ...
    :try_start_17
    iget-boolean v1, v10, Lcom/alibaba/wireless/security/framework/d$a;->d:Z
...
.method private a(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_1
    sget-boolean v1, Lcom/alibaba/wireless/security/framework/d;->p:Z
...
.method private a(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v5, "versionCompare(parentPluginVersion, nameVersionPair[1]) < 0"
    ...
    const-string/jumbo v5, "versionCompare(dependPlugin.getVersion(), nameVersionPair[1]) < 0"
...
.method public declared-synchronized getInterface(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/alibaba/wireless/security/framework/b;->d()Ljava/lang/String;
