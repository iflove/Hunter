.class public Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;
.super Ljava/lang/Object;
.source "StorageTracer.java"


# static fields
.field private static a:Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->a:Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;

    .line 28
    const-class v0, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->b:Ljava/lang/String;
...
.method public static declared-synchronized a()Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;
    .locals 2
    ...
    .line 31
    :try_start_0
    sget-object v1, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->a:Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;

    if-nez v1, :cond_0

    .line 32
    new-instance v1, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;

    invoke-direct {v1}, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;-><init>()V

    sput-object v1, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->a:Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;
...
.method private static a(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->b:Ljava/lang/String;

    const-string/jumbo v2, "obtainStorageStructure"
    ...
    invoke-virtual {v0, p0}, Lcom/alipay/android/phone/mobilesdk/apm/storage/StorageProcessor;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->b:Ljava/lang/String;
...
.method public final declared-synchronized a(Landroid/content/Context;Lcom/alipay/mobile/logmonitor/util/upload/UserDiagnostician$DiagnoseTask;Lcom/alipay/mobile/monitor/analysis/diagnose/UploadTaskStatus;)V
    ...
    .line 43
    .local v3, "storageTraceDir":Ljava/io/File;
    move-object v3, v0
    ...
    .end local p0    # "this":Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;
    :cond_1
    move-object v4, v2
    ...
    .line 48
    .end local v3    # "storageTraceDir":Ljava/io/File;
    .local v11, "storageTraceDir":Ljava/io/File;
    :goto_0
    ...
    :try_start_1
    invoke-static/range {p1 .. p1}, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 56
    .local v3, "storageStructure":Ljava/lang/String;
    move-object v3, v0
    ...
    .line 60
    .local v6, "tagFile":Ljava/io/File;
    move-object v6, v5

    const/4 v7, 0x1

    :try_start_2
    invoke-static {v5, v3, v7}, Lcom/alipay/mobile/monitor/util/FileUtils;->writeFile(Ljava/io/File;Ljava/lang/String;Z)V
    ...
    .end local v3    # "storageStructure":Ljava/lang/String;
    .end local v4    # "curLogFileName":Ljava/lang/String;
    .end local v6    # "tagFile":Ljava/io/File;
    :catch_0
    move-exception v0
    ...
    .line 56
    .restart local v3    # "storageStructure":Ljava/lang/String;
    :cond_4
    move-object v6, v2
    ...
    sget-object v4, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;->b:Ljava/lang/String;

    invoke-interface {v0, v4, v3}, Lcom/alipay/mobile/common/logging/api/trace/TraceLogger;->error(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v11, v4}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string v3, "[StorageTracer.startStorageTrace] "
    ...
    new-instance v7, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer$1;

    invoke-direct {v7, p0, v10, v14}, Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer$1;-><init>(Lcom/alipay/mobile/logmonitor/util/storage/StorageTracer;Lcom/alipay/mobile/monitor/analysis/diagnose/UploadTaskStatus;Ljava/lang/String;)V
    ...
    const-string v5, "[StorageTracer.startStorageTrace] "
    ...
    .end local v11    # "storageTraceDir":Ljava/io/File;
