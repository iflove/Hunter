...
.source "com_alipay_android_liteprocess_FrameworkMetaInfo.java"
...
.method public initDescriptionsWithMap(Ljava/util/Map;)V
    ...
    const-string v3, "com.alipay.mobile.liteprocess.LiteProcessPipeline"
    ...
    .line 43
    const-string v3, "com-alipay-android-liteprocess"

    invoke-direct {p0, p1, v3, v0}, Lcom/alipay/android/liteprocess/com_alipay_android_liteprocess_FrameworkMetaInfo;->insertDescription(Ljava/util/Map;Ljava/lang/String;Lcom/alipay/mobile/framework/MicroDescription;)V
    ...
    const-string v5, "com.alipay.mobile.liteprocess.LiteProcessPipeline2"

    invoke-virtual {v4, v5}, Lcom/alipay/mobile/framework/pipeline/ValveDescription;->setClassName(Ljava/lang/String;)Lcom/alipay/mobile/framework/MicroDescription;
    ...
    invoke-virtual {v2, v4}, Lcom/alipay/mobile/framework/msg/BroadcastReceiverDescription;->setClassName(Ljava/lang/String;)Lcom/alipay/mobile/framework/MicroDescription;

    .line 54
    const-string v5, "com.alipay.mobile.framework.BROUGHT_TO_FOREGROUND"

    const-string v6, "com.alipay.mobile.framework.USERLEAVEHINT"

    const-string v7, "com.alipay.mobile.framework.ACTIVITY_ALL_STOPPED"

    const-string v8, "com.alipay.mobile.framework.ACTIVITY_RESUME"

    const-string v9, "com.alipay.security.logout"

    const-string v10, "com.alipay.security.login"

    const-string v11, "com.alipay.android.broadcast.FORCE_LOGOUT_ACTION"
    ...
    .line 63
    invoke-direct {p0, p1, v3, v1}, Lcom/alipay/android/liteprocess/com_alipay_android_liteprocess_FrameworkMetaInfo;->insertDescription(Ljava/util/Map;Ljava/lang/String;Lcom/alipay/mobile/framework/MicroDescription;)V
